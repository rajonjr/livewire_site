<div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 border border-gray-100">
        ...
        <!-- COLONNE GAUCHE : Formulaire d'Inscription & Réseaux Sociaux -->
        <div class="p-8 sm:p-12 flex flex-col justify-center">
            <div class="text-center md:text-left mb-6">
                <h2 class="text-2xl font-bold text-gray-900">Créer un compte</h2>
                <p class="text-sm text-gray-500 mt-1">Rejoignez notre espace de coworking dès aujourd'hui.</p>
            </div>
            ...
            <form wire:submit.prevent="register">
                <div class="mb-3">
                    ...
                    <input type="text" wire:model="name" required autofocus placeholder="Votre Nom" class="mt-1 block w-full border border-gray-300 rounded-md p-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    @error('name') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                </div>

                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input type="email" wire:model="email" required placeholder="votre@email.com" class="mt-1 block w-full border border-gray-300 rounded-md p-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div class="mb-5">
                    ...
                    <input type="password" wire:model="password_confirmation" required placeholder="" class="mt-1 block w-full border border-gray-300 rounded-md p-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
        ...
        <div class="hidden md:flex relative bg-indigo-900 items-center justify-center p-12 overflow-hidden">
            <!-- Image de fond -->
            <div class="absolute inset-0 bg-cover bg-center opacity-30 mix-blend-overlay" style="background-image: url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=1000');"></div>
            ...
            <div class="relative z-10 text-white text-center max-w-sm">
                ...
                <h3 class="text-2xl font-bold mb-3">Démarrez l'aventure avec nous</h3>
                <p class="text-indigo-200 text-sm leading-relaxed">
                    Créez votre compte gratuit en quelques secondes et accédez à l'ensemble de nos services de réservation et de gestion d'abonnements.
                </p>
            </div>
        </div>
